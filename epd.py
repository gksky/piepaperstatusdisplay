...
clock_font = ImageFont.truetype('/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf', 48)
#firstTime = True
...
while (True):
    ...
    # ip_draw.text((0, 65), quote_data[0], font = quote_font, fill = 0)
        ...
        ip_draw.text((0, 65), f"{remaining_hours - 3}:{remaining_minutes}", font = clock_font, fill = 0)
